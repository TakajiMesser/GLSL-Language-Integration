...
namespace GLSLLanguageIntegration.Utilities
{
    public static class SnapshotExtensions
    {
        ...
        public static SnapshotSpan Translated(this SnapshotSpan span, SpanTrackingMode trackingMode, ITextSnapshot snapshot) => span.Snapshot != snapshot
            ? span.TranslateTo(snapshot, trackingMode)
            : span;
        ...
        public static SnapshotSpan Shifted(this SnapshotSpan span, int amount) =>
            new SnapshotSpan(span.Snapshot, span.Start + amount, span.Length);
    }
}
